...
$session_teacher_code = $_SESSION['teacher_code'];
$query = "select * from tbl_teacher where teacher_code = '$session_teacher_code' "; //GET NG DATA GALING SA DATABASE AT ILALABAS SA MGA DAPAT ILABAS
...
$update_query = "UPDATE `tbl_teacher` SET  `email` = '$up_email', `image` = '$image', `contact` = '$up_contact'";
...
header("refresh:0; url=profile-teacher.php");
...
header("refresh:0; url=profile-teacher.php?edit=$edit_id");
}
}
?>
...
<tr>
<td width="20%"><b>Teacher Code:</b></td>
<td width="30%"><?php echo $teacher_code;?></td>
...
<td width="30%"><?php echo $contact;?></td>
 ...
 <a href="profile-teacher.php?edit=<?php echo $id;?>" class="btn btn-default pull-right raised btn-sm">Update Profile</a>
