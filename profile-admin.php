...
$query = "select * from tbl_admin where username = '$session_username' "; //GET NG DATA GALING SA DATABASE AT ILALABAS SA MGA DAPAT ILABAS
...
$update_query = "UPDATE `tbl_admin` SET  `email` = '$up_email', `image` = '$image'";
...
//header("refresh:0; url=profile-admin.php");
...
header("refresh:0; url=profile-admin.php?edit=$edit_id");
}
}
?>
...
<td width="30%"><?php echo $lastname;?></td>
 ...
 <a href="profile-admin.php?edit=<?php echo $id;?>" class="btn btn-default pull-right raised btn-sm">Update Profile</a>
